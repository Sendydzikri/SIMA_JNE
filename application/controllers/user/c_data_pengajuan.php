...
class c_data_pengajuan extends CI_Controller {
	...
	public function tambah()
	{
		...
		if($this->form_validation->run() != false)
		{
			...
			$this->load->view('admin/kelola_user/template/header');
			$this->load->view('admin/kelola_user/template/sidenav');		
			$this->load->view('admin/kelola_user/data_user',$data);
			$this->load->view('admin/kelola_user/template/footer');
			$this->load->view('admin/kelola_user/template/__scriptData');
		}
